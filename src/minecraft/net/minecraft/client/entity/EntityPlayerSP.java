...
//			double d4 = (double) (this.rotationPitch - this.lastReportedPitch);
			...
			// --------
			// TACO ----- all commented code is replaced and edited below
			if (this.isRiding()) {
...
//						this.rotationYaw, this.rotationPitch, this.onGround));
				this.connection.sendPacket(new CPacketPlayer.PositionRotation(packetX, packetY, packetZ, packetYaw,
						packetPitch, packetOnGround));
			} else if (flag2) {
...
//				this.connection.sendPacket(new CPacketPlayer(this.onGround));
	...
	public void onLivingUpdate() {
		...
		if (this.onGround && !flag1 && !flag2 && this.movementInput.moveForward >= 0.8F && !this.isSprinting() && flag4
				&& !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS)) {
