...
public class GuiButton extends Gui {
	...
	public void func_191745_a(Minecraft p_191745_1_, int p_191745_2_, int p_191745_3_, float p_191745_4_) {
		if (this.visible) {
			...
			// Taco -------
			if (!this.enabled) {
				drawRect(this.xPosition + this.height / 8, this.yPosition - this.height / 8,
						this.xPosition + this.height / 8 + this.width,
						this.yPosition - this.height / 8 + this.height, 0x400097a7);
