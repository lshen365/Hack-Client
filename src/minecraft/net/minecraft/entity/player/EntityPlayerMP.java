...
public class EntityPlayerMP extends EntityPlayer implements IContainerListener {
	...
	public void readEntityFromNBT(NBTTagCompound compound) {
		...
		if (compound.hasKey("enteredNetherPosition", 10)) {
			...
			this.field_193110_cw = new Vec3d(nbttagcompound.getDouble("x"), nbttagcompound.getDouble("y"),
	...
	public void writeEntityToNBT(NBTTagCompound compound) {
		...
		if (entity != null && entity1 != this
				&& entity1.getRecursivePassengersByType(EntityPlayerMP.class).size() == 1) {
	...
	public void onUpdate() {
		...
		if (this.field_193107_ct != null) {
			CriteriaTriggers.field_193133_t.func_193162_a(this, this.field_193107_ct,
					this.ticksExisted - this.field_193108_cu);
		}
		...
		try {
			...
			for (int i = 0; i < this.inventory.getSizeInventory(); ++i) {
				...
				if (!itemstack.func_190926_b() && itemstack.getItem().isMap()) {
					Packet<?> packet = ((ItemMapBase) itemstack.getItem()).createMapDataPacket(itemstack, this.world,
							this);
	...
	public void onDeath(DamageSource cause) {
		...
		if (entitylivingbase != null) {
			EntityList.EntityEggInfo entitylist$entityegginfo = EntityList.ENTITY_EGGS
					.get(EntityList.func_191301_a(entitylivingbase));
	...
	public void displayGui(IInteractionObject guiOwner) {
		if (guiOwner instanceof ILootContainer && ((ILootContainer) guiOwner).getLootTable() != null
				&& this.isSpectator()) {
			this.addChatComponentMessage((new TextComponentTranslation("container.spectatorCantOpen", new Object[0]))
