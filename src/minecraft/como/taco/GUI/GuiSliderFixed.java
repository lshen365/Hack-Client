...
public class GuiSliderFixed extends GuiButton 
{
    ...
    public GuiSliderFixed(GuiPageButtonList.GuiResponder guiResponder, int idIn, int x, int y, String name, float min, float max, float defaultValue, GuiSlider.FormatHelper formatter)
    {
